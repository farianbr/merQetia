  ...
  return (
    <div className="st-page">
      <div className="st-header">
        ...
        <p className="st-sub">Manage your admin account information and preferences.</p>
      </div>
        ...
        <section className="card st-card st-card--danger">
          ...
          <div className="st-danger-actions">
            <div className="st-danger-row">
              <div>
                <span className="st-danger-action-title">Sign out of all sessions</span>
                <span className="st-danger-action-sub">Remove all active login sessions for this account.</span>
              </div>
