...
export const addExpenseTransaction = (id, data) => api.post(`/expenses/${id}/transactions`, data);
export const deleteExpenseTransaction = (id, txId) => api.delete(`/expenses/${id}/transactions/${txId}`);
